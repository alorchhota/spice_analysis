rule run_string_ppi_auc:
  input:
    absnet="{results_dir}/gtex_v8/results/{tissue}/{correction_label}/{gene_selection}/{n_genes}/{method}_absnet.rds",
    known = "{results_dir}/gtex_v8/results/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi.rds"
  params:
  ...
  log: 
    "{results_dir}/gtex_v8/logs/run_string_ppi_auc/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi_auc_{method}.log"
  shell:
    """
...
rule run_string_ppi_hub_auc:
  ...
  log: 
    "{results_dir}/gtex_v8/logs/run_string_ppi_hub_auc/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi_hub_auc_{method}.log"
  shell:
    """
...
rule run_string_ppi_spearman_cor:
  input:
    absnet="{results_dir}/gtex_v8/results/{tissue}/{correction_label}/{gene_selection}/{n_genes}/{method}_absnet.rds",
    known = "{results_dir}/gtex_v8/results/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi.rds"
  params:
  ...
  log: 
    "{results_dir}/gtex_v8/logs/run_string_ppi_spearman_cor/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi_spearman_cor{method}.log"
  shell:
    """
...
rule run_string_ppi_precision:
  ...
  log: 
    "{results_dir}/gtex_v8/logs/run_string_ppi_precision/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi_precision{method}.log"
  shell:
    """
...
rule run_string_ppi_geodesic_rankdiff:
  input:
    absnet="{results_dir}/gtex_v8/results/{tissue}/{correction_label}/{gene_selection}/{n_genes}/{method}_absnet.rds",
    known = "{results_dir}/gtex_v8/results/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi.rds"
  params:
  ...
  log:
    "{results_dir}/gtex_v8/logs/run_string_ppi_geodesic_rankdiff/{tissue}/{correction_label}/{gene_selection}/{n_genes}/string_ppi_geodesic_rankdiff_{method}.log"
  shell:
    """
