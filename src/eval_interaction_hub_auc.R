...
args <- add_argument(args, "--o", help="Output file (rds)", default="results/string_hub_auc.rds")
...
### compute auc
interaction_hub_auc = spice::coexpression_known_interactions_hub_auc(
  net = net_mat,
...
### save
saveRDS(interaction_hub_auc, file = out_fn)
